...
func new_gem() *GlobalEntityManager {
    rootEntity := &proto.BaseEntity{Name: "GemRoot"}
	rootEntity.Init()
	return &GlobalEntityManager{root: rootEntity, fixed_update_timer: *util.NewTimer(0.035)}
}
...
func print_tree(entity proto.Entity, depth int32, last bool) {
    ...
    logging.Debug("%v%v", prefix, entity.GetName())
