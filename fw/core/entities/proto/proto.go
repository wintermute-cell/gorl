...
type IEntity2D interface {
	...
	AddOnSetPositionCallback(callback func(new_position rl.Vector2))
	AddOnSetScaleCallback(callback func(new_scale rl.Vector2))
	AddOnSetRotationCallback(callback func(new_rotation float32))
}
